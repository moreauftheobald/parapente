...
.wr-modal .wr-leg{display:flex;align-items:center;gap:4px;font-size:10px;color:rgba(255,255,255,0.55)}
...
.wr-modal .wr-stat-label{font-size:10px;color:rgba(255,255,255,0.58);margin-bottom:4px;display:flex;align-items:center;gap:4px}
...
.wr-modal .wr-stat-sub{font-size:10px;color:rgba(255,255,255,0.58);margin-top:3px}
...
.wr-modal .wr-tl-header{display:flex;justify-content:space-between;font-size:10px;color:rgba(255,255,255,0.55);margin-bottom:5px}
...
.wr-modal .wr-tl-hours{display:flex;justify-content:space-between;margin-top:3px;font-size:9px;color:rgba(255,255,255,0.55)}
