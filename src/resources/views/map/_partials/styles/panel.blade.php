        ...
        .panel-header { padding:18px 20px 0; border-bottom:1px solid var(--c-border-4); flex-shrink:0; }
        ...
        .panel-meta { display:flex; align-items:center; gap:8px; margin-top:6px; font-size:12px; color:#6b7280; font-family:var(--font-mono); }
        ...
        .panel-sun .mono { color:#e5e7eb; font-family:var(--font-mono); }
        ...
        .pg-day-arrow { width:30px; height:30px; border-radius:50%; border:1px solid var(--c-border-5); background:rgba(31,41,55,.4); color:#9ca3af; cursor:pointer; font-size:14px; display:flex; align-items:center; justify-content:center; flex-shrink:0; transition:all .15s; }
        ...
        .panel-conformity .val { font-family:var(--font-mono); color:#e5e7eb; min-width:32px; text-align:right; }

        .panel-legend { padding:10px 20px; background:rgba(17,24,39,.95); border-bottom:1px solid var(--c-border-4); display:flex; flex-wrap:wrap; gap:6px; flex-shrink:0; position:sticky; top:0; z-index:5; backdrop-filter:blur(6px); }
        .pg-chip { display:inline-flex; align-items:center; gap:6px; padding:4px 10px; border-radius:999px; background:rgba(31,41,55,.6); border:1px solid var(--c-border-5); font-size:12px; color:#e5e7eb; user-select:none; }
        ...
        .panel-footer { padding:10px 20px; border-top:1px solid var(--c-border-4); flex-shrink:0; display:flex; justify-content:space-between; font-size:10px; color:#374151; }
