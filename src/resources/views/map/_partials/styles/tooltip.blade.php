        ...
        #chart-tooltip { position:fixed; z-index:80; background:var(--c-bg-dark); border:1px solid rgba(75,85,99,.7); border-radius:10px; padding:10px 12px; font-size:11px; color:#e5e7eb; pointer-events:none; box-shadow:0 12px 32px rgba(0,0,0,.7); min-width:200px; max-width:260px; }
        #chart-tooltip .tt-hour { font-size:13px; font-weight:600; color:#fff; margin-bottom:8px; font-family:var(--font-mono); }
        ...
        #chart-tooltip .tt-row .val { color:#fff; font-family:var(--font-mono); font-size:11px; white-space:nowrap; }
        #chart-tooltip .tt-row.consensus { padding-bottom:5px; margin-bottom:5px; border-bottom:1px solid var(--c-border-5); }
