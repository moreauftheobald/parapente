...
.rp2 .hero-lbl{font-size:9px;color:rgba(255,255,255,0.58);text-align:right;margin-top:1px}
...
.rp2 .block{padding:0 18px;margin-bottom:11px}
.rp2 .blbl{font-size:10px;color:rgba(255,255,255,0.55);margin-bottom:5px;display:flex;justify-content:space-between;align-items:center}
...
.rp2 .cax span{font-size:9px;color:rgba(255,255,255,0.55)}
.rp2 .chart-outer{position:relative;width:100%}
.rp2 .chart-outer canvas{display:block;width:100%;height:140px;cursor:crosshair}
.rp2 .hover-line{position:absolute;top:0;width:1px;background:rgba(255,255,255,0.15);pointer-events:none;display:none;height:140px}
...
.rp2 .wax span{font-size:9px;color:rgba(255,255,255,0.55)}
.rp2 .wind-leg{display:flex;gap:7px;margin-top:5px;flex-wrap:wrap}
.rp2 .wleg{display:flex;align-items:center;gap:3px;font-size:9px;color:rgba(255,255,255,0.55)}
...
.rp2 .mr-lbl{font-size:9px;color:rgba(255,255,255,0.55);margin-bottom:3px}
.rp2 .mr-row{display:flex;gap:9px}
.rp2 .mrv{font-size:12px;font-weight:500}
.rp2 .mrvu{font-size:9px;color:rgba(255,255,255,0.58);font-weight:400}
.rp2 .mrsub{font-size:9px;color:rgba(255,255,255,0.55);margin-top:1px}
...
.rp2 .dnavb{width:20px;height:20px;border-radius:4px;background:rgba(255,255,255,0.05);border:0.5px solid rgba(255,255,255,0.07);display:flex;align-items:center;justify-content:center;cursor:pointer;color:rgba(255,255,255,0.62);font-size:10px;transition:all 0.15s}
...
.rp2 .plbl{font-size:10px;color:rgba(255,255,255,0.62);width:70px;flex-shrink:0;text-align:right}
...
.rp2 .dsc-d{font-size:9px;color:rgba(255,255,255,0.55)}
...
.rp2 .sleg{display:flex;align-items:center;gap:3px;font-size:9px;color:rgba(255,255,255,0.55)}
...
.rp2 .vtab{padding:6px 10px;font-size:10px;color:rgba(255,255,255,0.58);cursor:pointer;border-bottom:2px solid transparent;white-space:nowrap;display:flex;align-items:center;gap:3px;transition:all 0.15s;flex-shrink:0}
...
.rp2 .mch-unit{font-size:9px;color:rgba(255,255,255,0.55)}
.rp2 .ribbon-wrap{position:relative;width:100%;height:150px}
.rp2 .ribbon-wrap canvas{display:block;width:100%;height:150px}
...
.rp2 .mleg-line{width:12px;height:1.5px;border-radius:1px;background:rgba(255,255,255,0.55)}
...
.rp2 .mod-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:3px;padding:6px 14px 12px;border-top:0.5px solid rgba(255,255,255,0.06)}
...
.rp2 .mchip.cons{border-color:rgba(255,255,255,0.55);background:rgba(255,255,255,0.05)}
.rp2 .chip-c{width:7px;height:7px;border-radius:2px;flex-shrink:0}
.rp2 .chip-n{font-size:9px;color:rgba(255,255,255,0.68);flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
